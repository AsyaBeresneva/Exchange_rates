...
import dat from './data/dollar_rate.csv';
...
export class TabPanel1 extends Component {
    render() {
        return (
            ...
            <div className='H2'>Динамика курсов валют за период</div>
...
const GBPrate = () => {
    const options = {
        ...
        theme: "light2",
        title:{
            text: "Фунт стерлингов (GBP, ЦБ РФ)",
        },        
        axisX:{
            valueFormatString: "DD MMM",
            crosshair: {
